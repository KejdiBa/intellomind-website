...
function InboxScreen() {
  ...
  const totalCount = visibleMessages.reduce((sum, idx) => sum + messages[idx].count, 0);
    ...
    <div className="absolute inset-0 flex flex-col bg-gradient-to-br from-cyan-600/90 via-blue-700/90 to-purple-800/90 pt-10">
      <div className="flex items-center justify-between px-4 py-2 border-b border-white/5">
        ...
        <div className="relative">
          ...
          <span
            key={`badge-${cycleKey}`}
            className="absolute -top-1 -right-1 w-4 h-4 bg-red-500 rounded-full text-[10px] text-white flex items-center justify-center animate-scale-in"
      ...
      <div className="flex-1 overflow-hidden p-3 space-y-2">
        {messages.map((msg, i) =>
          visibleMessages.includes(i) ? (
            <div
              ...
              className="flex items-center gap-3 p-3 bg-slate-800/40 rounded-xl animate-item-in"
            >
              ...
              <div className="w-5 h-5 bg-purple-600 rounded-full flex items-center justify-center text-[10px] text-white font-bold animate-scale-in" style={{ animationDelay: "0.2s" }}>
                {msg.count}
              </div>
            </div>
          ) : null
        ...
        {visibleMessages.length === messages.length && (
          <div className="pt-2 animate-stats-up">
  ...
  return (
    <div className="absolute inset-0 flex flex-col bg-gradient-to-br from-cyan-600/90 via-blue-700/90 to-purple-800/90 pt-10">
      <div className="flex items-center justify-between px-4 py-2 border-b border-white/5">
        ...
        <span className="text-xs text-[#ebf9fa]">
          24. Mai
        </span>
      </div>
      <div className="flex-1 overflow-hidden p-3 space-y-2">
        ...
        {showStats && (
          <div className="pt-3 space-y-2 animate-stats-up">
            <div className="flex items-center justify-between text-xs">
              <span className="text-slate-400">Auslastung heute</span>
              <span className="font-medium text-[#f0ebf5]">{progressWidth}%</span>
            </div>
        ...
        {isMobile ? (
          <div className="relative">
            ...
            <div className="space-y-3 relative z-10 pt-6 pb-4 px-4">
              ...
              <div
                key={currentStep}
                className="text-center space-y-3 animate-step-text"
              >
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center w-full">
            <div>
              <div
                key={currentStep}
                className="space-y-4 animate-step-text"
              >
