  ...
  return (
    <section className="py-24 bg-background relative overflow-hidden" data-testid="section-features">
      <div className="absolute inset-0">
        <div className="bg-gradient-orb bg-gradient-orb-purple w-[400px] h-[400px] top-0 right-1/4 opacity-20" />
      </div>
      ...
      <div className="max-w-6xl mx-auto px-6 relative z-10">
        ...
        >
          <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold mb-6">
            ...
            <span className="gradient-text-pink">heute nutzen</span>
          </h2>
          ...
          {features.map((feature, index) => (
            ...
            >
              ...
              >
                ...
                <div className="text-lg font-semibold gradient-text-pink mb-2">
                  {feature.label}
                </div>
